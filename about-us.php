...
<div class="container my-5 py-5 z-depth-1">
    <section class="text-center px-md-5 mx-md-5 dark-grey-text">
		<div class="row d-flex justify-content-center">
        	<div class="col-lg-12">
				<h1>Family</h1>
				<p>Heron Constructive Solutions Ltd. is a family run business, three generations now work hard to provide services for our clients. Each generation gladly comes onbord bringing ideas which allows us to grow.</p>
				<p>Together we have over 50 years experience in this sector.</p>
			</div>
      	</div>
    </section>
</div>
...
<div class="container my-5 py-5 z-depth-1">
    <section class="text-center px-md-5 mx-md-5 dark-grey-text">
		<div class="row d-flex justify-content-center">
        	<div class="col-lg-12">
				<h1>Our Workforce</h1>
				<p>The team is highly skilled with many years experience between them. We ensure that for each contract we use reveantly skilled members of the team.</p>
				<p>All team members have Health and Safety training specific to each contract.</p>
				<p>With risk assessments, method statements and other contract documents in place for each contract, our team are well informed and well equipped to ensure safe working.</p>
			</div>
      	</div>
    </section>
</div>
    ...
    <section class="text-center px-md-5 mx-md-5 dark-grey-text">
		<div class="row d-flex justify-content-center">
        	<div class="col-lg-12">
				...
				<p>Heron Constructive Solutions Ltd. prides itself on giving high quality finishes for our clients.</p>
				<p>The standard of materials is throughtly checked and suppliers sourced to maintain quality workmainship of completed jobs.</p>
			</div>
      	</div>
    </section>
</div>
